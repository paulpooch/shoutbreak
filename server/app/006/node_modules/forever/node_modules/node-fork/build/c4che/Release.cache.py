...
CPPPATH_NODE = '/home/ec2-user/server/node/include/node'
CPPPATH_ST = '-I%s'
CXX = ['/usr/bin/g++']
CXXDEFINES_ST = '-D%s'
CXXFLAGS = ['-g']
...
LIBDIR = '/home/ec2-user/.node_libraries'
LIBPATH_NODE = '/home/ec2-user/server/node/lib'
LIBPATH_ST = '-L%s'
LIB_ST = '-l%s'
LINKFLAGS_MACBUNDLE = ['-bundle', '-undefined', 'dynamic_lookup']
LINK_CXX = ['/usr/bin/g++']
NODE_PATH = '/home/ec2-user/.node_libraries'
PREFIX = '/usr/local'
PREFIX_NODE = '/home/ec2-user/server/node'
